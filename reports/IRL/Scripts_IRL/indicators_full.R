...
### P11
 ...
 write.csv(table_quant_p11, './reports/IRL/tables/final/table_quantiles_p11.csv')
...
### p12
 ...
 write.csv(table_quant_p12, './reports/IRL/tables/final/table_quantiles_p12.csv')
 ### P13
 ...
 write.csv(table_quant_p13, './reports/IRL/tables/final/table_quantiles_p13.csv')
 ...
 write.csv(table_quant_p21, './reports/IRL/tables/final/table_quantiles_p21.csv')
 ### P22
 ...
 write.csv(table_quant_p22, './reports/IRL/tables/final/table_quantiles_p22.csv')
 ### P23
 ...
 write.csv(table_quant_p23, './reports/IRL/tables/final/table_quantiles_p23.csv')